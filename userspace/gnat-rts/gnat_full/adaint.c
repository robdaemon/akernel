...
#elif defined (AKERNEL_NO_UTIME)
  /*  newlib riscv64-elf has no utime(); our fs keeps no
      timestamps anyway (53b). */
  (void) name; (void) time_stamp;
#else
...
#ifndef AKERNEL_NO_DIRENT  /*  53b: the pool already provides this
                              one (adaint-xi.c); use our catch-all
                              guard rather than add another. */
const void *
