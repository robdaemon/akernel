...
--  Akernel_User.Clipboard (milestone 9x): client API for the
--  system clipboard — a resident shared library (Sys:Libs/
--  Clipboard, opened via Akernel_User.Libs.Open_Library, which
...
--  base).
package Akernel_User.Clipboard is
