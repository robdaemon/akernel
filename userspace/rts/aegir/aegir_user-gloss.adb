...
package body Aegir_User.Gloss is
   ...
   --  appended (Aegir_User.Tables); the chunk index IS the fd
   ...
   package FD_Tab is new Aegir_User.Tables (FD_Rec);
   ...
   --  (env.c, adaint.c); aegir_init_args runs from crt0.
   ...
   function Aegir_Env_Get
     (Name  : Interfaces.C.Strings.chars_ptr;
      Buf   : System.Address;
      Bufsz : C_Int) return C_Int;
   pragma Export (C, Aegir_Env_Get, "aegir_env_get");
   ...
   function Aegir_Env_Set
     (Name  : Interfaces.C.Strings.chars_ptr;
      Value : Interfaces.C.Strings.chars_ptr) return C_Int;
   pragma Export (C, Aegir_Env_Set, "aegir_env_set");
   ...
   function Aegir_Env_Unset
     (Name : Interfaces.C.Strings.chars_ptr) return C_Int;
   pragma Export (C, Aegir_Env_Unset, "aegir_env_unset");
   ...
   package Dir_Tab is new Aegir_User.Tables (Dir_Rec);
   function Dir_Slots (I : Natural) return Dir_Tab.Element_Access
     renames Dir_Tab.Ref;

   function Aegir_Opendir
     (Name : Interfaces.C.Strings.chars_ptr) return C_Int;
   pragma Export (C, Aegir_Opendir, "aegir_opendir");
   ...
   function Aegir_Readdir
     (D     : C_Int;
      Buf   : System.Address;
      Bufsz : C_Int) return C_Int;
   pragma Export (C, Aegir_Readdir, "aegir_readdir");
   ...
   function Aegir_Closedir (D : C_Int) return C_Int;
   pragma Export (C, Aegir_Closedir, "aegir_closedir");

   function Aegir_Closedir (D : C_Int) return C_Int is
   begin
      if D < 0 or else Natural (D) >= Dir_Tab.Last then
         return -1;
      end if;
   ...
   --  gnat_argc/gnat_argv; crt0 calls aegir_init_args, which
   ...
   procedure Aegir_Init_Args;
   pragma Export (C, Aegir_Init_Args, "aegir_init_args");

   procedure Aegir_Init_Args is
   ...
   --  the rdtime CSR (10 MHz on qemu virt — aegir_rtclock.c).
   ...
   --  (gloss.o is always pulled via the -u in aegir_program.gpr,
