...
package body Aegir_User.Console is
   ...
   Bound          : Boolean := False;
   Stream_Storage : aliased Aegir_User.Streams.Endpoint_Stream;
   ...
   begin
      ...
      if Redir_Pipe then
         declare
            Ignore : constant U64 := Aegir_User.Files.Close
   ...
   begin
      if not Bound and then Console_Endpoint /= 0 then
         Aegir_User.Streams.Set_Endpoint
   ...
   function Stream return access Aegir_User.Streams.Endpoint_Stream is
   begin
      Bind;
   ...
   begin
      ...
      if Console_Endpoint = 0 then
         Aegir_User.Syscalls.Debug_Put (S);
         return;
      end if;
      ...
      begin
         ...
         Aegir_User.Streams.Write (Stream_Storage, Item);
      end;
   end Put;
