...
package body Aegir_User.Sockets is
   use type U32;
   ...
   --  table (Aegir_User.Tables); the VA window below caps live
   ...
   package Client_Tab is new Aegir_User.Tables (Client_Sock);
