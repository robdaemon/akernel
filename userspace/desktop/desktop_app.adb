...
package body Desktop_App is
   ...
   --  elevation at own handle 5, netserv at 6, libman at 7 (args
   --  at 4) — so Desktop can hand its children the same uniform
   --  layout and spawned Drawers reach the shared clipboard.
   Elevated_EP : constant U64 := 5;
   Net_EP      : constant U64 := 6;
   Libman_EP   : constant U64 := 7;
